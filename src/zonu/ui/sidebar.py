...
class Sidebar(QtGui.QWidget):
    ...
    def __init__(self, parent, config):
        ...
        self.board_tree = BoardTree(self, self.config) 
...
class BoardTree(QtGui.QTreeWidget):
    ...
    def __init__(self, parent, config):
        ...
        for site_iden in site_idens:
            site_item = SiteTreeWidgetItem(self, site_iden)
            ...
            for board_iden in site_iden.board_idens:
                board_item = BoardTreeWidgetItem(site_item, board_iden)
    ...
    def contextMenuEvent(self, event):
        ...
        if item in self.site_items.values():
            ...
            assert isinstance(item, BoardTreeWidgetItem)
            menu = QtGui.QMenu(self)
...
class SiteTreeWidgetItem(QtGui.QTreeWidgetItem):
...
class BoardTreeWidgetItem(QtGui.QTreeWidgetItem):
